...
AdUi.prototype.createControls = function () {
  ...
  this.assignControlAttributes(this.playPauseDiv, 'ima-play-pause-div vjs-svg-icon');
  this.playPauseDiv.innerHTML='<svg viewBox="0 0 32 32"><use href="#vjs-icon-play"></use></svg>';
  this.addClass(this.playPauseDiv, 'ima-playing');
  this.playPauseDiv.addEventListener('click', this.onAdPlayPauseClick.bind(this), false);

  this.assignControlAttributes(this.muteDiv, 'ima-mute-div vjs-svg-icon');
  this.muteDiv.innerHTML='<svg viewBox="0 0 32 32"><use href="#vjs-icon-volume3"></use></svg>';
  ...
  this.assignControlAttributes(this.fullscreenDiv, 'ima-fullscreen-div vjs-svg-icon');
  this.fullscreenDiv.innerHTML='<svg viewBox="0 0 32 32"><use href="#vjs-icon-fullscreen"></use></svg>';
...
AdUi.prototype.onAdsPlaying = function () {
  ...
  this.playPauseDiv.innerHTML = '<svg viewBox="0 0 32 32"><use href="#vjs-icon-pause"></use></svg>';
...
AdUi.prototype.mute = function () {
  this.muteDiv.innerHTML = '<svg viewBox="0 0 32 32"><use href="#vjs-icon-mute"></use></svg>';
...
AdUi.prototype.onPlayerEnterFullscreen = function () {
  this.fullscreenDiv.innerHTML='<svg viewBox="0 0 32 32"><use href="#vjs-icon-fullscreen-back"></use></svg>';
};
