...
| **WEB** (Laravel, TALL stack) | `frontend-specialist` | frontend-design, tailwind-patterns |
| **BACKEND** (PHP, Eloquent, API) | `backend-specialist` | api-patterns, database-design |
...
| `security-auditor` | Master Cybersecurity (Laravel Audit + Pentest + Infra) |
| `backend-specialist` | Backend Architect (Laravel + PHP 8.2+ + Eloquent) |
| `frontend-specialist` | Frontend & Growth (Livewire + Blade + Alpine.js + SEO) |
| `mobile-developer` | Mobile Specialist (Cross-platform + Mobile Performance)|
| `debugger` | Systematic Root Cause Analysis & Bug Fixing |
| `performance-optimizer` | Speed, Web Vitals, Laravel Optimization |
